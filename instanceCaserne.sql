...
-- On remplit donc les casernes de facon incomplete puis on complete les casernes une fois les adresses ins�r�es.

INSERT INTO Caserne
    (Id_caserne,Capa_camions,Capa_pompiers,Num_rue,Nom_rue,Nom_ville,CP)
...
INSERT INTO Ville
    (Nom_ville,Nb_hab,CP)
VALUES('Draguignan', 20000, 83240);
INSERT INTO Ville
    (Nom_ville,Nb_hab,CP)
VALUES('Draguignan', 300, 83242);
INSERT INTO Ville
    (Nom_ville,Nb_hab,CP)
VALUES('Draguignan', 2400, 83244);
INSERT INTO Ville
    (Nom_ville,Nb_hab,CP)
VALUES('Brignoles', 1650, 83620);
INSERT INTO Ville
    (Nom_ville,Nb_hab,CP)
VALUES('Le Luc', 4580, 83620);
INSERT INTO Ville
    (Nom_ville,Nb_hab,CP)
VALUES('Lajoie', 25000, 83450);
INSERT INTO Ville
    (Nom_ville,Nb_hab,CP)
VALUES('Shadok', 14630, 83666);
INSERT INTO Ville
    (Nom_ville,Nb_hab,CP)
VALUES('Papou', 3655, 83220);
INSERT INTO Ville
    (Nom_ville,Nb_hab,CP)
VALUES('Pierrefiques', 134, 83620);
INSERT INTO Ville
    (Nom_ville,Nb_hab,CP)
VALUES('Montreuil', 20400, 83100);
INSERT INTO Ville
    (Nom_ville,Nb_hab,CP)
VALUES('Trantown', 18500, 83220);

--table Adresse
INSERT INTO Adresse
    (Num_rue,Nom_rue,CP,Nom_ville,Type_habitation,Proche_caserne,Km)
...
INSERT INTO Adresse
    (Num_rue,Nom_rue,CP,Nom_ville,Type_habitation)
...
VALUES(1, 'Draguignan', 83240);
INSERT INTO Protege
    (Id_caserne,Nom_ville,CP)
VALUES(1, 'Brignoles', 83620);
INSERT INTO Protege
    (Id_caserne,Nom_ville,CP)
VALUES(1, 'Le Luc', 83620);
INSERT INTO Protege
    (Id_caserne,Nom_ville,CP)
VALUES(4, 'Le Luc', 83620);
INSERT INTO Protege
    (Id_caserne,Nom_ville,CP)
VALUES(2, 'Papou', 83220);
INSERT INTO Protege
    (Id_caserne,Nom_ville,CP)
VALUES(2, 'Draguignan', 83240);
INSERT INTO Protege
    (Id_caserne,Nom_ville,CP)
VALUES(3, 'Shadok', 83666);
INSERT INTO Protege
    (Id_caserne,Nom_ville,CP)
VALUES(3, 'Draguignan', 83240);
INSERT INTO Protege
    (Id_caserne,Nom_ville,CP)
VALUES(4, 'Brignoles', 83620);
INSERT INTO Protege
    (Id_caserne,Nom_ville,CP)
VALUES(4, 'Draguignan', 83240);

COMMIT;
-- on insere ces donnees
END TRANSACTION;
--fin de transaction
...
INSERT INTO Fabricant
    (Nom_fabricant,Delai,Num_rue,Nom_rue,CP,Nom_ville)
...
--table Modele
INSERT INTO Modele
    (Nom_modele,Type_modele,Motorisation,Nom_fabricant)
VALUES
    ('Daminator', 'K2000', 'Top', 'Peugeot');
INSERT INTO Modele
    (Nom_modele,Type_modele,Motorisation,Nom_fabricant)
VALUES
    ('Laignel_vnr', 'N800', 'Tip', 'Mercedes_benz');
INSERT INTO Modele
    (Nom_modele,Type_modele,Motorisation,Nom_fabricant)
VALUES
    ('Truite', 'ARN', 'Tip', 'Mercedes_benz');
INSERT INTO Modele
    (Nom_modele,Type_modele,Motorisation,Nom_fabricant)
VALUES
    ('GrosColosse', 'SPQR', 'Tiptop', 'Peugeot');

--table Pompier
INSERT INTO Pompier
    (Id_caserne,Id_pompier,Nom,Prenom,Nom_rue,Num_rue,Nom_ville,CP)
VALUES
    (1, 1, 'Marchand', 'Louis', 'Licorne', 18, 'Draguignan', 83240);
INSERT INTO Pompier
    (Id_caserne,Id_pompier,Nom,Prenom,Nom_rue,Num_rue,Nom_ville,CP)
VALUES
    (2, 1, 'Valjean', 'Jean', 'Dragon', 50, 'Papou', 83220);
INSERT INTO Pompier
    (Id_caserne,Id_pompier,Nom,Prenom,Nom_rue,Num_rue,Nom_ville,CP)
VALUES
    (4, 1, 'Antoinette', 'Marie', 'Lion', 6, 'Montreuil', 83100);
INSERT INTO Pompier
    (Id_caserne,Id_pompier,Nom,Prenom,Nom_rue,Num_rue,Nom_ville,CP)
VALUES
    (3, 1, 'Montant', 'Yves', 'Baleine', 9, 'Shadok', 83666);
INSERT INTO Pompier
    (Id_caserne,Id_pompier,Nom,Prenom,Nom_rue,Num_rue,Nom_ville,CP)
VALUES
    (3, 2, 'Montant', 'Sylvain', 'Dragon', 50, 'Papou', 83220);
INSERT INTO Pompier
    (Id_caserne,Id_pompier,Nom,Prenom,Nom_rue,Num_rue,Nom_ville,CP)
VALUES
    (3, 3, 'Savairien', 'Jean', 'Dragon', 50, 'Papou', 83220);
INSERT INTO Pompier
    (Id_caserne,Id_pompier,Nom,Prenom,Nom_rue,Num_rue,Nom_ville,CP)
VALUES
    (2, 2, 'Conchon', 'Sylvain', 'Stupide', 14, 'Le Luc', 83620);
INSERT INTO Pompier
    (Id_caserne,Id_pompier,Nom,Prenom,Nom_rue,Num_rue,Nom_ville,CP)
VALUES
    (3, 4, 'Jumper', 'Jolly', 'Baleine', 9, 'Le Luc', 83620);
